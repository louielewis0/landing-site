...
export const metadata: Metadata = {
  title: "Review Growth System | Real Estate Market Center",
  description:
    "Automated 5-star review collection and Google Maps domination strategy for Real Estate Market Center — Metro Detroit.",
};
