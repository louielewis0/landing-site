...
export default function EditableField({
  ...
  const sharedClass =
    "w-full px-3 py-2 rounded-lg bg-bone/[0.04] border border-bone/15 text-bone text-[13.5px] placeholder-bone/35 focus:outline-none focus:border-[var(--gold)]/60 focus:bg-bone/[0.07] transition-all";

  return (
    <div className="grid grid-cols-[110px_1fr] gap-3 py-1.5 items-start">
      <label className="text-[11px] text-bone/45 uppercase tracking-[0.18em] pt-2.5">
        {label}
      </label>
      {multiline ? (
        <textarea
