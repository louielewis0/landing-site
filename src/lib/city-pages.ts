...
export const cityPages: CityPage[] = [
  {
    ...
    faqs: [
      ...
      { question: "Why choose Real Estate Market Center to buy or sell in Troy?", answer: "We are not a franchise desk — we are a Troy-based family brokerage that has worked this specific market for over 20 years, with our office on E Square Lake Rd. You get one point of contact from first call to closing, street-level pricing knowledge across Northfield Hills, Emerald Lakes, and South Troy, and marketing tailored to the actual buyer for your home. Founded by broker Sundus Lewis in 2003, we have closed 500+ homes and hold a perfect 5.0-star client rating." },
    ],
